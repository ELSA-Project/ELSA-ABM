...
G = network_whose_name_is('../networks/Real_LI_v5.8_Strong_EXTLIRR_LIRR_2010-5-6+0_d2_cut240.0_directed')

name_G = 'Real_LI_v5.8_Strong_EXTLIRR_LIRR_2010-5-6+0_d2_cut240.0_directed'

#save_file = '../trajectories/M1/trajectories.dat'
save_file = '../trajectories/M1/test_rectificate.dat'
...
save_file_capacities = '../networks/Real_LI_v5.8_Strong_EXTLIRR_LIRR_2010-5-6+0_d2_cut240.0_directed_flights_selected_capacities.dat'
